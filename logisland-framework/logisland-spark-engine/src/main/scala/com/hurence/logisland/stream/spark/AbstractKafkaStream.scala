...
import com.hurence.logisland.component.{AbstractConfigurableComponent, AllowableValue, PropertyDescriptor}
...
abstract class AbstractKafkaStream(val appName: String,
    ...
    protected val processorChainContext = new StandardProcessContext(processorChainInstance)
