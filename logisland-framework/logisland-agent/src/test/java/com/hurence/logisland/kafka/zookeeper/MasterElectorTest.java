//
//package com.hurence.logisland.kafka.zookeeper;
//
...
//import com.hurence.logisland.kafka.registry.RestApp;
//import com.hurence.logisland.kafka.utils.TestUtils;
//
...
//
//import static com.hurence.logisland.avro.AvroCompatibilityLevel.FORWARD;
//import static com.hurence.logisland.avro.AvroCompatibilityLevel.NONE;
//import static org.junit.Assert.*;
//
//public class MasterElectorTest extends ClusterTestHarness {
//  private static final int ID_BATCH_SIZE =
//      KafkaRegistry.ZOOKEEPER_SCHEMA_ID_COUNTER_BATCH_SIZE;
//  private static final String ZK_ID_COUNTER_PATH =
//      "/schema_registry" + KafkaRegistry.ZOOKEEPER_SCHEMA_ID_COUNTER;
//
//  @Test
...
//    restApp1.restClient
//        .updateCompatibility(FORWARD.name, configSubject);
...
//    restApp2.restClient
//        .updateCompatibility(NONE.name, configSubject);
...
//    try {
//      restApp1.restClient.updateCompatibility(FORWARD.name,
//              configSubject);
...
//    try {
//      restApp2.restClient.updateCompatibility(FORWARD.name,
//              configSubject);
...
//                                          RegistryIdentity expectedMasterIdentity) {
//    for (RestApp restApp: cluster) {
...
//   */
//  private static Set<RegistryIdentity> getMasterIdentities(Collection<RestApp> cluster) {
//    Set<RegistryIdentity> masterIdentities = new HashSet<>();
