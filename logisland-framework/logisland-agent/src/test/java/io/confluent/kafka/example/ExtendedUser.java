...
public class ExtendedUser extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static io.confluent.kafka.example.ExtendedUser.Builder newBuilder() {
    return new io.confluent.kafka.example.ExtendedUser.Builder();
  }
  
  /** Creates a new ExtendedUser RecordBuilder by copying an existing Builder */
  public static io.confluent.kafka.example.ExtendedUser.Builder newBuilder(io.confluent.kafka.example.ExtendedUser.Builder other) {
    return new io.confluent.kafka.example.ExtendedUser.Builder(other);
  }
  
  /** Creates a new ExtendedUser RecordBuilder by copying an existing ExtendedUser instance */
  public static io.confluent.kafka.example.ExtendedUser.Builder newBuilder(io.confluent.kafka.example.ExtendedUser other) {
    return new io.confluent.kafka.example.ExtendedUser.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExtendedUser>
    ...
    private Builder() {
      super(io.confluent.kafka.example.ExtendedUser.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(io.confluent.kafka.example.ExtendedUser.Builder other) {
      super(other);
    ...
    private Builder(io.confluent.kafka.example.ExtendedUser other) {
            super(io.confluent.kafka.example.ExtendedUser.SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'name' field */
    public io.confluent.kafka.example.ExtendedUser.Builder setName(java.lang.CharSequence value) {
    ...
    public io.confluent.kafka.example.ExtendedUser.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'age' field */
    public io.confluent.kafka.example.ExtendedUser.Builder setAge(int value) {
    ...
    public io.confluent.kafka.example.ExtendedUser.Builder clearAge() {
