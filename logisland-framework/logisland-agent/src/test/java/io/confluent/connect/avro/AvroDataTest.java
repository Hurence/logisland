...
public class AvroDataTest {
  ...
  public void testFromConnectComplex() {
    ...
    assertEquals(avroSchema, ((GenericRecord) convertedRecord).getSchema());
  ...
  public void testFromConnectOptionalComplex() {
    ...
    GenericRecord  avroStruct = new GenericRecordBuilder(structAvroSchema)
                                                          .set("int32", 12)
                                                          .build();
    GenericRecord  mapNonStringKeysAvroStruct = new GenericRecordBuilder(mapNonStringKeysAvroSchema)
    ...
    avroRecord = new GenericRecordBuilder(avroSchema)
        .set("int32", 12)
