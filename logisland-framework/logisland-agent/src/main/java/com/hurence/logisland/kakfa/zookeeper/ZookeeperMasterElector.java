 ...
 */
package com.hurence.logisland.kakfa.zookeeper;
...
public class ZookeeperMasterElector {
  ...
  private final KafkaRegistry schemaRegistry;
  ...
  public void electMaster() throws
          RegistryStoreException, RegistryTimeoutException {
    RegistryIdentity masterIdentity = null;
    try {
  ...
  public void readCurrentMaster()
    ...
    try {
      ...
      try {
        masterIdentity = RegistryIdentity.fromJson(masterIdentityString);
  ...
  private class SessionExpirationListener implements IZkStateListener {
    ...
    public void handleSessionEstablishmentError(Throwable t) throws Exception {
      ...
      throw new RegistryStoreException("Couldn't establish Zookeeper connection", t);
    }
  }
}
