...
import com.hurence.logisland.kafka.registry.exceptions.RegistryInitializationException;
import com.hurence.logisland.kafka.registry.exceptions.RegistryStoreException;
import com.hurence.logisland.kafka.registry.exceptions.RegistryTimeoutException;
import com.hurence.logisland.kafka.serialization.Serializer;
import com.hurence.logisland.kafka.store.*;
import com.hurence.logisland.kafka.zookeeper.RegistryIdentity;
import com.hurence.logisland.kafka.zookeeper.ZookeeperMasterElector;
...
public class KafkaRegistry {
    ...
    public KafkaStore<RegistryKey, RegistryValue> getJobsKafkaStore() {
        return this.jobsKafkaStore.getKafkaStore();
    }
}
