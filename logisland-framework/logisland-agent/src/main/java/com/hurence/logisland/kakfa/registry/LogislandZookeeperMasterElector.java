...
public class LogislandZookeeperMasterElector {

    private static final Logger log = LoggerFactory.getLogger(LogislandZookeeperMasterElector.class);
    ...
    public LogislandZookeeperMasterElector(ZkUtils zkUtils,
                                           SchemaRegistryIdentity myIdentity,
                                           LogislandKafkaRegistry schemaRegistry,
