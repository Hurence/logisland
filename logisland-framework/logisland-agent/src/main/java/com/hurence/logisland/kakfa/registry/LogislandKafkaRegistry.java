...
import io.confluent.kafka.schemaregistry.exceptions.*;
...
public class LogislandKafkaRegistry implements SchemaRegistry {
    ...
    private static final Logger log = LoggerFactory.getLogger(io.confluent.kafka.schemaregistry.storage.KafkaSchemaRegistry.class);
    ...
    private LogislandZookeeperMasterElector masterElector = null;
    ...
    public LogislandKafkaRegistry(SchemaRegistryConfig config,
        ...
        kafkaStore =
                new KafkaStore<SchemaRegistryKey, SchemaRegistryValue>(
                        config,
                        new LogislandKafkaStoreMessageHandler(this),
                        this.serializer,
    ...
    public void init() throws SchemaRegistryInitializationException {
        ...
        try {
            createZkNamespace();
            masterElector = new LogislandZookeeperMasterElector(zkUtils, myIdentity, this,
