...
public class RegistryIdentity {
  ...
  public RegistryIdentity(@JsonProperty("host") String host,
  ...
  public static RegistryIdentity fromJson(String json) throws IOException {
    return new ObjectMapper().readValue(json, RegistryIdentity.class);
  }
  ...
  public boolean equals(Object o) {
    ...
    RegistryIdentity that = (RegistryIdentity) o;
