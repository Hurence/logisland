...
.. code-block:: sh
    ...
    cd /opt
    sudo wget https://github.com/Hurence/logisland/releases/download/v0.10.2/logisland-0.10.2-bin-hdp2.5.tar.gz

    export SPARK_HOME=/opt/spark-2.1.0-bin-hadoop2.7/
    export HADOOP_CONF_DIR=$SPARK_HOME/conf

    sudo /opt/logisland-0.10.2/bin/logisland.sh --conf /home/hurence/tom/logisland-conf/v0.10.0/future-factory.yml
