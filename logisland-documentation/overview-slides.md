...
```
Using Logisland home: /usr/local/bin/logisland-1.1.1
...
```
Artifact: com.hurence.logisland:logisland-processor-common:1.1.1
Name: Common processors bundle
Version: 1.1.1
Location: /usr/local/bin/logisland-1.1.1/lib/logisland-processor-common-1.1.1.jar
Components provided:
...
Download the latest release from [github](https://github.com/Hurence/logisland/releases)
	...
	tar -xzf logisland-1.1.1-bin.tar.gz
