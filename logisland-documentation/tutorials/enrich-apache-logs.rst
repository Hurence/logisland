...
.. code-block:: sh
    ...
    bin/components.sh -i com.hurence.logisland:logisland-processor-enrichment:1.1.0

    bin/components.sh -i com.hurence.logisland:logisland-processor-useragent:1.1.0
