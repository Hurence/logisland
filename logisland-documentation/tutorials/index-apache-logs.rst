...
.. code-block:: sh
    ...
    bin/components.sh -i com.hurence.logisland:logisland-service-mongodb-client:1.1.0

    bin/components.sh -i com.hurence.logisland:logisland-service-solr_6_6_2-client:1.1.0
