...
public class KuraPayloadDecoderTest {
    ...
    public void validateIntegration() throws IOException {
        ...
        // byte[] bytes = protPayload.toByteArray();


        byte[] bytes2 = new byte[]{8, -50, -36, -93, -46,                               -106, 44, -62, -72, 2, 18, 10, 5, 99, 111, 110, 115, 116, 16, 0, 25, -10,           40, 92, -113, -62,                    53, 69, 64};
        byte[] bytes5 = new byte[]{                                                                                    5, 99, 111, 110, 115, 116, 16, 0, 25, -17, -65, -67, 40, 92, -17, -65, -67, -17, -65, -67, 53, 69, 64};
        byte[] bytes3 = new byte[]{8, -44, -127,                    -17, -65, -67, -45, -106, 44, -62, -72, 2, 18, 10, 5, 99, 111, 110, 115, 116, 16, 0, 25, -17, -65, -67, 40, 92, -17, -65, -67, -17, -65, -67, 53, 69, 64};
        byte[] bytes4 = new byte[]{8, -17, -65, -67, -17, -65, -67, -17, -65, -67, -45, -106, 44, -62, -72, 2, 18, 10, 5, 99, 111, 110, 115, 116, 16, 0, 25, -17, -65, -67, 40, 92, -17, -65, -67, -17, -65, -67, 53, 69, 64};




        byte[] bytesK0 = new byte[]{8, -124, -102, -120, -44, -106, 44, -62, -72, 2, 18, 10, 5, 99, 111, 110, 115, 116, 16, 0, 25, -10, 40, 92, -113, -62, 53, 69, 64};
        byte[] bytesK1 = new byte[]{8, -19, -95,   -120, -44, -106, 44, -62, -72, 2, 18, 10, 5, 99, 111, 110, 115, 116, 16, 0, 25, -10, 40, 92, -113, -62, 53, 69, 64};
        byte[] bytesK2 = new byte[]{8, -44, -87,   -120, -44, -106, 44, -62, -72, 2, 18, 10, 5, 99, 111, 110, 115, 116, 16, 0, 25, -10, 40, 92, -113, -62, 53, 69, 64};
        byte[] bytesK3 = new byte[]{8, -65, -79,   -120, -44, -106, 44, -62, -72, 2, 18, 10, 5, 99, 111, 110, 115, 116, 16, 0, 25, -10, 40, 92, -113, -62, 53, 69, 64};
