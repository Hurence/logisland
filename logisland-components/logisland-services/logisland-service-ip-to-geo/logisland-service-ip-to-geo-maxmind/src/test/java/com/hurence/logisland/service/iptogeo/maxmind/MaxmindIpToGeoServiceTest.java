...
public class MaxmindIpToGeoServiceTest {
    ...
    public static Object[][] testIpToGeoServiceProvider() {
        ...
        enResult.put(GEO_FIELD_SUBDIVISION + SEPARATOR + "0", "England");
        enResult.put(GEO_FIELD_SUBDIVISION_ISOCODE + SEPARATOR + "0", "ENG");
        enResult.put(GEO_FIELD_SUBDIVISION + SEPARATOR + "1", "West Berkshire");
        enResult.put(GEO_FIELD_SUBDIVISION_ISOCODE + SEPARATOR + "1", "WBK");
        ...
        enResult2.put(GEO_FIELD_SUBDIVISION + SEPARATOR + "0", "England");
        ...
        frResult2.put(GEO_FIELD_SUBDIVISION + SEPARATOR + "0", "Angleterre");
