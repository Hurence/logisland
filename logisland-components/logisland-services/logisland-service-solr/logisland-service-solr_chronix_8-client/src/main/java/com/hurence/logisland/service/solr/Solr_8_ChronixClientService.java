...
@Tags({"solr", "client"})
@CapabilityDescription("Implementation of ChronixClientService for Solr 8")
public class Solr_8_ChronixClientService extends AbstractControllerService implements DatastoreClientService {

    private static Logger logger = LoggerFactory.getLogger(Solr_8_ChronixClientService.class);
