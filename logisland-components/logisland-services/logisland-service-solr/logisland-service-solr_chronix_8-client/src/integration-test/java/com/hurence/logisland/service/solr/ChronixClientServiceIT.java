...
public class ChronixClientServiceIT {
    ...
    private class MockSolrClientService extends Solr_8_ChronixClientService {
    ...
    private DatastoreClientService configureClientService(final TestRunner runner) throws InitializationException {
        ...
        final Solr_8_ChronixClientService service = new MockSolrClientService();
        runner.addControllerService("service", service);
        runner.setProperty(service, Solr_8_ChronixClientService.SOLR_COLLECTION, "chronix" );
