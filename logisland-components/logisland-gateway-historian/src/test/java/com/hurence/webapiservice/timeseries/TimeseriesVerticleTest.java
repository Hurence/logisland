...
import static com.hurence.webapiservice.timeseries.impl.TimeseriesServiceImpl.*;
...
public class TimeseriesVerticleTest {
    ...
    @Test
    @Timeout(value = 5, timeUnit = TimeUnit.SECONDS)
    void unCompressTimeSeriesTestBeforeEnd(VertxTestContext testContext) throws Throwable {
        JsonObject params = new JsonObject()
                .put(CHUNK, "")
                .put(START, 1570634183825L)
                .put(END, 1570634188310L);

        timeseries.unCompressTimeSeries(params, testContext.succeeding(timeseries -> {
            testContext.verify(() -> {
                assertEquals(25, timeseries.size());
                JsonObject point1 = timeseries.getJsonObject(0);
                assertEquals(new JsonObject()
                        .put("timestamp", 1570634183825L)
                        .put("value", 73.64336502906335d), point1);
