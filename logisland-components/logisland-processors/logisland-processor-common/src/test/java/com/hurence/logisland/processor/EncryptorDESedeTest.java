...
public class EncryptorDESedeTest {
    @Test
    public void testProcessingEncryptionNoPadding() {
        ...
        testRunner.setProperty(EncryptField.ALGO, "DESede/CBC/NoPadding");
        testRunner.setProperty(EncryptField.KEY, "azerty123456789012345678");
        ...
        testRunner2.setProperty(EncryptField.ALGO, "DESede/CBC/NoPadding");
        testRunner2.setProperty(EncryptField.KEY, "azerty123456789012345678");
    ...
    public void testProcessingEncryptionAllTypesDES() throws Exception {
        ...
        TestRunner testRunner = TestRunners.newTestRunner(new EncryptField());
        testRunner.setProperty(EncryptField.MODE, EncryptField.ENCRYPT_MODE);
        testRunner.setProperty(EncryptField.ALGO, "DESede/CBC/PKCS5Padding");
        testRunner.setProperty(EncryptField.KEY, "azerty123456789012345678");
        ...
        TestRunner testRunner2 = TestRunners.newTestRunner(new EncryptField());
        testRunner2.setProperty(EncryptField.MODE, EncryptField.DECRYPT_MODE);
        testRunner2.setProperty(EncryptField.ALGO, "DESede/CBC/PKCS5Padding");
        testRunner2.setProperty(EncryptField.KEY, "azerty123456789012345678");
