...
/**
 *
 * Use IncrementalWebSession instead. This is the old version of web session calculation. It can
 * make duplicate session in case of high frequency of batches (typically while rewind).
 */
...
@Deprecated()
public class IncrementalWebSessionOld
...
//        debug("Entering processor with %s ", records);
    ...
    private static class InvalidSessionCheckResult
        ...
        public InvalidSessionCheckResult(final String reason) {
            this.reason = reason;
        }
