...
public class QueryMatcherProcessor extends AbstractProcessor {
    ...
    private static String EVENT_MATCH_TYPE = "alert_match";
    ...
    private Map<String, MatchingRule> matchingRules = new HashMap<>();
    private NumericQueryParser queryMatcher = new NumericQueryParser("field");
