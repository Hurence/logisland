...
public class QueryMatcherProcessorTest {
    ...
    public void validateNoMatch() {
        final TestRunner testRunner = TestRunners.newTestRunner(new QueryMatcherProcessor());
    ...
    public void testNumericRangeQuery() {
        final TestRunner testRunner = TestRunners.newTestRunner(new QueryMatcherProcessor());
        testRunner.setProperty(QueryMatcherProcessor.NUMERIC_FIELDS, "exception_count,average_bytes");
