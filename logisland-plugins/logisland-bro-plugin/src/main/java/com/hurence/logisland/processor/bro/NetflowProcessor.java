...
public class NetflowProcessor extends AbstractProcessor {

    private static Logger logger = LoggerFactory.getLogger(NetflowProcessor.class);
    ...
    public Collection<Record> process(ProcessContext context, Collection<Record> records)
    {
        ...
        records.forEach(record -> {
            ...
            byte[] recordValue1=null;
            try {
                recordValue1 = ((String) record.getField(FieldDictionary.RECORD_VALUE).getRawValue()).getBytes("US-ASCII");
