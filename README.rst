...
Currently supported version of kafka is: **2.11** with preferred tested release : **0.10.0.0** 

Replace kafka_version and kafka_release in the below code to install the required kafka.
