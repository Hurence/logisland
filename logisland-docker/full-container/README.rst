...
.. code-block:: sh
    ...
    # build logisland
    mvn clean install
    cp logisland-assembly/target/logisland-1.0.0-RC2-bin.tar.gz logisland-docker
...
.. code-block:: sh
    ...
    docker build --rm -t hurence/logisland:1.0.0-RC2 .
...
.. code-block:: sh
    ...
    docker run \
        ...
        --name logisland \
        -h sandbox \
        hurence/logisland-hdp2.4:1.0.0-RC2 bash

or

.. code-block::

    docker run -d -h sandbox hurence/logisland-hdp2.4:1.0.0-RC2 -d
