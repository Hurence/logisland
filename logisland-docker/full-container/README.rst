...
.. code-block:: sh
    ...
    # build logisland
    mvn clean install
    cp logisland-assembly/target/logisland-0.10.3-bin.tar.gz logisland-docker
...
.. code-block:: sh
    ...
    docker build --rm -t hurence/logisland:0.10.3 .
...
.. code-block:: sh
    ...
    docker run \
        ...
        --name logisland \
        -h sandbox \
        hurence/logisland-hdp2.4:0.10.3 bash

or

.. code-block::

    docker run -d -h sandbox hurence/logisland-hdp2.4:0.10.3 -d
