...
.. code-block:: sh
    ...
    cp logisland-assembly/target/logisland-1.1.1-bin.tar.gz logisland-docker/full-container
...
.. code-block:: sh
    ...
    docker tag hurence/logisland:latest hurence/logisland:1.1.1
...
.. code-block:: sh
    ...
    docker run \
        ...
        --name logisland \
        -h sandbox \
        hurence/logisland:1.1.1 bash

or

.. code-block::

    docker run -d -h sandbox hurence/logisland:1.1.1 -d
