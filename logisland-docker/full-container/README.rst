...
.. code-block:: sh
    ...
    # build logisland
    mvn clean install
    cp logisland-assembly/target/logisland-0.15.0-bin.tar.gz logisland-docker
...
.. code-block:: sh
    ...
    docker build --rm -t hurence/logisland:0.15.0 .
...
.. code-block:: sh
    ...
    docker run \
        ...
        --name logisland \
        -h sandbox \
        hurence/logisland-hdp2.4:0.15.0 bash

or

.. code-block::

    docker run -d -h sandbox hurence/logisland-hdp2.4:0.15.0 -d
