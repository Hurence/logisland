...
//    @Ignore
    public void myTest() throws IOException, InterruptedException, InitializationException {
        ...
        confKafka.put(StreamProperties.KAFKA_ZOOKEEPER_QUORUM().getName(), embeddedKafka.getZookeeperConnectionString());
        confKafka.put(StreamProperties.KAFKA_METADATA_BROKER_LIST().getName(), embeddedKafka.getBrokersAsString());
