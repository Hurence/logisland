 ...
 *
 */
public class MockComponentLogger extends StandardComponentLogger implements ComponentLog {

    public MockComponentLogger(String componentId, Object component) {
