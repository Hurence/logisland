...
.. code-block:: sh
    ...
    cd /opt
    wget https://github.com/prometheus/node_exporter/releases/download/1.2.0/node_exporter-1.1.2.linux-amd64.tar.gz -O /tmp/node_exporter-1.1.2.linux-amd64.tar.gz
    sudo tar -xvzf /tmp/node_exporter-1.2.0.linux-amd64.tar.gz
