...
.. code-block:: sh
    ...
    cd /opt
    sudo wget https://github.com/Hurence/logisland/releases/download/v1.2.0/logisland-1.1.2-bin.tar.gz

    export SPARK_HOME=/opt/spark-2.1.0-bin-hadoop2.7/
    export HADOOP_CONF_DIR=$SPARK_HOME/conf

    sudo /opt/logisland-1.2.0/bin/logisland.sh --conf /home/hurence/tom/logisland-conf/v0.10.0/future-factory.yml
