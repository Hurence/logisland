...
.. code-block:: sh
    ...
    bin/components.sh -i com.hurence.logisland:logisland-service-elasticsearch_5_4_0-client:1.2.0

    bin/components.sh -i com.hurence.logisland:logisland-connector-opc:1.2.0
