...
.. code-block:: sh
    ...
    docker cp ./h2-1.4.197.jar logisland:/opt/logisland-1.2.0/lib
...
.. code-block:: sql
    ...
    INSERT into apache values (default, 1.2.08,'GET','/images/dual-pad.gif','200' ,'HTTP/1.0 ', '1995-07-01 04:04:10' ,'isdn6-34.dnai.com', '-');
