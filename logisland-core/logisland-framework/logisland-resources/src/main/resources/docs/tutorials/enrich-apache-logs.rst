...
.. code-block:: sh
    ...
    bin/components.sh -i com.hurence.logisland:logisland-processor-elasticsearch:1.2.0

    bin/components.sh -i com.hurence.logisland:logisland-service-elasticsearch_2_4_0-client:1.2.0

    bin/components.sh -i com.hurence.logisland:logisland-processor-enrichment:1.2.0

    bin/components.sh -i com.hurence.logisland:logisland-processor-useragent:1.2.0
