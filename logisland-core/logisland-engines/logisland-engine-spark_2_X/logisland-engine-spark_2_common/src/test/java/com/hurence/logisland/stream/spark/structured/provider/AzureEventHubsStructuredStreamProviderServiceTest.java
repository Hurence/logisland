...
public class AzureEventHubsStructuredStreamProviderServiceTest {
    ...
    public void testConfig() throws InitializationException {
        ...
        try {
            ...
            final TestRunner runner = TestRunners.newTestRunner("com.hurence.logisland.processor.datastore.BulkPut");
            runner.addControllerService("eventhubs_service", service);
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_NAMESPACE().getName(), "namespace");
            runner.enableControllerService(service);
            error = true;
        ...
        try {
            ...
            runner.addControllerService("eventhubs_service", service);
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_NAMESPACE().getName(), "namespace");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_EVENT_HUB().getName(), "read_hub");
            runner.enableControllerService(service);
            error = true;
        ...
        try {
            ...
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_NAMESPACE().getName(), "namespace");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_EVENT_HUB().getName(), "read_hub");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY_NAME().getName(), "read_sas_key_name");
            runner.enableControllerService(service);
            error = true;
        ...
        try {
            ...
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_EVENT_HUB().getName(), "read_hub");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY_NAME().getName(), "read_sas_key_name");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY().getName(), "read_sas_key");
            runner.enableControllerService(service);
            error = true;
        ...
        try {
            ...
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY_NAME().getName(), "read_sas_key_name");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY().getName(), "read_sas_key");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_POSITION().getName(), "bad 0123456789 value");
            runner.enableControllerService(service);
            error = true;
        ...
        try {
            ...
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY_NAME().getName(), "read_sas_key_name");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY().getName(), "read_sas_key");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_POSITION_TYPE().getName(), "bad value");
            runner.enableControllerService(service);
            error = true;
        ...
        try {
            ...
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY_NAME().getName(), "read_sas_key_name");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY().getName(), "read_sas_key");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_POSITION_TYPE().getName(), "sequenceNumber");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_CONSUMER_GROUP().getName(), "consumerGroup");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_RECEIVER_TIMEOUT().getName(), "123");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_PREFETCH_COUNT().getName(), "456");
            runner.enableControllerService(service);
        ...
        try {
            ...
            runner.addControllerService("eventhubs_service", service);
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_NAMESPACE().getName(), "namespace");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_WRITE_EVENT_HUB().getName(), "write_hub");
            runner.enableControllerService(service);
            error = true;
        ...
        try {
            ...
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_NAMESPACE().getName(), "namespace");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_WRITE_EVENT_HUB().getName(), "write_hub");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_WRITE_SAS_KEY_NAME().getName(), "write_sas_key_name");
            runner.enableControllerService(service);
            error = true;
        ...
        try {
            ...
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_WRITE_EVENT_HUB().getName(), "write_hub");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_WRITE_SAS_KEY_NAME().getName(), "write_sas_key_name");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_WRITE_SAS_KEY().getName(), "write_sas_key");
            runner.enableControllerService(service);
        ...
        try {
            ...
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY_NAME().getName(), "read_sas_key_name");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY().getName(), "read_sas_key");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_POSITION().getName(), "1234");
            runner.enableControllerService(service);
        ...
        try {
            ...
            runner.addControllerService("eventhubs_service", service);
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_NAMESPACE().getName(), "namespace");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_MAX_EVENTS_PER_TRIGGER().getName(), "987");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_OPERATION_TIMEOUT().getName(), "654");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_THREAD_POOL_SIZE().getName(), "321");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_EVENT_HUB().getName(), "read_hub");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY_NAME().getName(), "read_sas_key_name");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_SAS_KEY().getName(), "read_sas_key");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_POSITION().getName(), "8963");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_POSITION_TYPE().getName(), "offset");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_CONSUMER_GROUP().getName(), "consumerGroup");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_RECEIVER_TIMEOUT().getName(), "8436");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_READ_PREFETCH_COUNT().getName(), "4723");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_WRITE_EVENT_HUB().getName(), "write_hub");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_WRITE_SAS_KEY_NAME().getName(), "write_sas_key_name");
            runner.setProperty(service, AzureEventHubProperties.EVENTHUBS_WRITE_SAS_KEY().getName(), "write_sas_key");
            runner.enableControllerService(service);
