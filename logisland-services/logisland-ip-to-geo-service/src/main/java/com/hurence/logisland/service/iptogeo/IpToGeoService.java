...
public interface IpToGeoService extends ControllerService {
     ...
     */
    public static final String GEO_FIELD_LOOKUP_TIME_MICROS = "geo.lookup.micros";
    /**
     * The city identified for the IP address
     */
    public static final String GEO_FIELD_CITY = "geo.city";
    /**
     * The longitude identified for the IP address
     */
    public static final String GEO_FIELD_LATITUDE = "geo.latitude";
    /**
     * The longitude identified for the IP address
     */
    public static final String GEO_FIELD_LONGITUDE = "geo.longitude";
    /**
     ...
     */
    public static final String GEO_FIELD_SUBDIVISION = "geo.subdivision.";
    /**
     * The ISO code for the subdivision that is identified by GEO_FIELD_SUBDIVISION
     */
    public static final String GEO_FIELD_SUBDIVISION_ISOCODE = "geo.subdivision.isocode.";
    /**
     * The country identified for the IP address
     */
    public static final String GEO_FIELD_COUNTRY = "geo.country";
    /**
     * The ISO Code for the identified country
     */
    public static final String GEO_FIELD_COUNTRY_ISOCODE = "geo.country.isocode";
    /**
     * The postal code for the identified country
     */
    public static final String GEO_FIELD_POSTALCODE = "geo.postalcode";
