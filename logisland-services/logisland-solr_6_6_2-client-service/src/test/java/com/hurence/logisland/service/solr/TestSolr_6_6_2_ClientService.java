...
public class TestSolr_6_6_2_ClientService {
    ...
    private static Logger logger = LoggerFactory.getLogger(TestSolr_6_6_2_ClientService.class);
    ...
    private Solr_6_6_2_ClientService configureSolrClientService(final TestRunner runner) throws InitializationException
    {
        ...
        final Solr_6_6_2_ClientService service = runner.getProcessContext().getPropertyValue(TestProcessor.SOLR_CLIENT_SERVICE).asControllerService(Solr_6_6_2_ClientService.class);
        return service;
    }
    ...
    public void testVersion() throws Exception {
        ...
        Assert.assertTrue(solrClientService.getClient().getClass().getPackage().getImplementationVersion().contains("6.6.2"));
    }
    ...
    public void testBasics() throws Exception {
        ...
        final Solr_6_6_2_ClientService solrClientService = configureSolrClientService(runner);
